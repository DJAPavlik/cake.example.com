...
<header class="row">
   ...
   <!-- <img src="./MyPic.jepg" alt="My 1st Test Cake">
        <img src="/www/var/cake.example.com/src/Template/MyPage/MyCake.jpg" alt="My Test Cake"> -->
   </div>
    <div class="header-title">
        <h1>Welcome to Dennis' CakePHP Demonstration Pages</h1> 
    </div>
</header>
<div class="top-bar-section">
            <ul class="right">
            <li><a href="/MyPage">My Demo Page</a></li>
